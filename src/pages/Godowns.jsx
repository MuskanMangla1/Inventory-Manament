  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between mb-10">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 text-white px-5 py-2.5 rounded-xl shadow hover:bg-blue-700 hover:shadow-lg transition-all duration-200"
          >
            <PlusCircle size={18} />
            Add Godown
          </button>
      ...
      {loading ? (
        ...
        <p className="text-center text-gray-500 bg-gray-50 border border-gray-200 rounded-xl py-6 shadow-sm">
          No godowns found.
        </p>
      ) : (
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((g) => (
            <div
              ...
              className="group bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-xl hover:border-blue-500 transition-all duration-300 cursor-pointer p-6"
            >
